...
const Index = () => {
  ...
  return (
    <Layout>
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-brand-light via-accent to-white py-16 md:py-24">
        <div className="container relative z-10 mx-auto px-4 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-8 md:mb-0 md:pr-8">
            ...
            <p className="mb-6 text-lg md:text-xl text-gray-600 max-w-xl animate-slide-in" style={{ animationDelay: "0.2s" }}>
              Explore our curated collection of premium electronics, from noise-canceling headphones to smart home devices.
            </p>
      ...
      <section className="py-12 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            <Link to="/products?category=Electronics&subcategory=Audio" className="group relative rounded-lg overflow-hidden">
              <img 
            ...
            <Link to="/products?category=Electronics&subcategory=Smartphones" className="group relative rounded-lg overflow-hidden">
              <img 
              ...
              />
              <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
                <h3 className="text-white text-xl font-semibold">Smartphones</h3>
              </div>
            </Link>
            <Link to="/products?category=Electronics&subcategory=Laptops" className="group relative rounded-lg overflow-hidden">
              <img 
            ...
            <Link to="/products?category=Electronics&subcategory=Smart+Home" className="group relative rounded-lg overflow-hidden">
              <img 
      ...
      <section className="py-12 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            ...
            <Link to="/products?featured=true" className="flex items-center text-primary hover:underline">
      ...
      <section className="py-12 bg-background">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            ...
            <Link to="/products?new=true" className="flex items-center text-primary hover:underline">
              View All <ArrowRight className="ml-1 h-4 w-4" />
            </Link>
          </div>
          <div className="product-grid">
      ...
      <section className="py-12 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            ...
            <Link to="/products?on_sale=true" className="flex items-center text-primary hover:underline">
              View All <ArrowRight className="ml-1 h-4 w-4" />
            </Link>
          </div>
          <div className="product-grid">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center">
              <div className="bg-white p-4 rounded-full mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-brand-primary h-8 w-8"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
              </div>
            ...
            <div className="flex flex-col items-center text-center">
              <div className="bg-white p-4 rounded-full mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-brand-primary h-8 w-8"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"></path></svg>
              </div>
            ...
            <div className="flex flex-col items-center text-center">
              <div className="bg-white p-4 rounded-full mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-brand-primary h-8 w-8"><path d="m7.9 20 6.2-16h2l-6.2 16Z"></path><path d="M4 17h8"></path><path d="M12 7h8"></path></svg>
              </div>
